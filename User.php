  ...
  <div class="container">
    ...
    <div class="row">
      <div class="offset-2 col-md-8">
        ...
        <form action="action/user.php" method="post" class="mt-4" enctype="multipart/form-data">
          <div class="row mt-4">
            <div class="col-md-6 mt-2 ">
              <label for="inputPassword5" class="form-label">Full Name</label>
              <input type="text" name="Full_Name" id="inputPassword5" required class="form-control" aria-describedby="passwordHelpBlock">
            ...
            <div class="col-md-6 mt-2">
              ...
              <input type="email" name="email" id="inputPassword5" required class="form-control" aria-describedby="passwordHelpBlock">
              <div id="passwordHelpBlock" class="form-text d-none">
                Your password must be 8-20 characters long, contain letters and numbers, and must not contain spaces, special characters, or emoji.
              </div>
            </div>
            <div class="col-md-6 mt-2">
              ...
              <input type="text" name="password" id="inputPassword5" required class="form-control" aria-describedby="passwordHelpBlock">
              <div id="passwordHelpBlock" class="form-text d-none">
                Your password must be 8-20 characters long, contain letters and numbers, and must not contain spaces, special characters, or emoji.
              </div>
            </div>
